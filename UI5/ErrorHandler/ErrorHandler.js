sap.ui.define([
    ...
    return UI5Object.extend("com.wartsila.mobile.cman.estimates.controller.ErrorHandler", {
        ...
        _showServiceError: function (oDetails) {
            ...
            if (oDetails.responseText !== undefined) {
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            sMensaje = sHtml.content[1].content[0].content[0];
                        } catch (errHTMLParse) {
                            sMensaje = "";
                        }
                    }
                ...
                if (oError && oError.error) {
                    if (oError.error.message.value) {
                        sMensaje = oError.error.message.value;
                    } else {
                        sMensaje = oError.error.message["#text"];
                    }
                } else if (oError && oError.html) {
                    sMensaje = oError.html.body.h1["#text"];
                } else if (!sMensaje) {
                    sMensaje = "";
                }
            }
            if (sMensaje) {
                ...
                sMensaje = this._oComponent.getModel("i18n").getResourceBundle().getText("Error.UnknownError");
            }
        },
        /** 
         * Convert JSON to XML.
